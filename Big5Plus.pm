...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Big5Plus software provides)

Big5Plus software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Big5Plus software provide)
...
=head1 Escaping File Test Operators (Big5Plus software provide)
