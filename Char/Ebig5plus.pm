...
BEGIN {
    ...
    sub Char::Ebig5plus::binmode(*;$);
    sub Char::Ebig5plus::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Ebig5plus::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Ebig5plus::open;
    }
}
        ...
        for my $prefix (@INC) {
            ...
            if (Char::Ebig5plus::f($realfilename)) {
                ...
                if (Char::Ebig5plus::e("$realfilename.e")) {
                    ...
                    if ($script =~ m/^ \s* use \s+ Char::Big5Plus \s* ([^;]*) ; \s* \n? $/oxms) {
...
=item Make character
  ...
  set. For example, Char::Ebig5plus::chr(65) is "A" in either ASCII or Big5Plus, and
  Char::Ebig5plus::chr(0x82a0) is a Big5Plus HIRAGANA LETTER A. For the reverse of Char::Ebig5plus::chr,
  use Char::Big5Plus::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Ebig5plus::binmode(FILEHANDLE, $disciplines);
  Char::Ebig5plus::binmode(FILEHANDLE);
  Char::Ebig5plus::binmode($filehandle, $disciplines);
  Char::Ebig5plus::binmode($filehandle);

  * two arguments

  If you are using perl5.005 other than MacPerl, Char::Big5Plus software emulate perl5.6's
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Ebig5plus::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Ebig5plus::open(FILEHANDLE, $expr);
  $rc = Char::Ebig5plus::open(FILEHANDLE);
  $rc = Char::Ebig5plus::open(my $filehandle, $mode, $expr);
  $rc = Char::Ebig5plus::open(my $filehandle, $expr);
  $rc = Char::Ebig5plus::open(my $filehandle);

  * autovivification filehandle
  * three arguments

  If you are using perl5.005, Char::Big5Plus software emulate perl5.6's open function.
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Ebig5plus::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Ebig5plus::open my $fh, ">logfile" or die ...
  ...
  Char::Ebig5plus::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Ebig5plus::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Ebig5plus::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Ebig5plus::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Ebig5plus::open(FH, "<:crlf:encoding(Char::Big5Plus)", $path) or die "can't open $path: $!";
