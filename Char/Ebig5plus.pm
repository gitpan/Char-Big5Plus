...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Ebig5plus::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Ebig5plus::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
sub Char::Ebig5plus::fc(@);
sub Char::Ebig5plus::fc_();
...
${Char::Ebig5plus::anchor}      = qr{\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?}oxms;
BEGIN { CORE::eval q{ use vars qw(
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Char::Ebig5plus::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Char::Ebig5plus::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Char::Ebig5plus::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Char::Ebig5plus::anchor} = ${Char::Ebig5plus::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
# ${Char::Ebig5plus::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Ebig5plus::eS}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s])};
...
${Char::Ebig5plus::not_space}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s\x0B])};
...
# avoid: Name "Char::Ebig5plus::foo" used only once: possible typo at here.
${Char::Ebig5plus::dot}         = ${Char::Ebig5plus::dot};
${Char::Ebig5plus::dot_s}       = ${Char::Ebig5plus::dot_s};
${Char::Ebig5plus::eD}          = ${Char::Ebig5plus::eD};
${Char::Ebig5plus::eS}          = ${Char::Ebig5plus::eS};
${Char::Ebig5plus::eW}          = ${Char::Ebig5plus::eW};
${Char::Ebig5plus::eH}          = ${Char::Ebig5plus::eH};
${Char::Ebig5plus::eV}          = ${Char::Ebig5plus::eV};
${Char::Ebig5plus::eR}          = ${Char::Ebig5plus::eR};
${Char::Ebig5plus::eN}          = ${Char::Ebig5plus::eN};
${Char::Ebig5plus::not_alnum}   = ${Char::Ebig5plus::not_alnum};
${Char::Ebig5plus::not_alpha}   = ${Char::Ebig5plus::not_alpha};
${Char::Ebig5plus::not_ascii}   = ${Char::Ebig5plus::not_ascii};
${Char::Ebig5plus::not_blank}   = ${Char::Ebig5plus::not_blank};
${Char::Ebig5plus::not_cntrl}   = ${Char::Ebig5plus::not_cntrl};
${Char::Ebig5plus::not_digit}   = ${Char::Ebig5plus::not_digit};
${Char::Ebig5plus::not_graph}   = ${Char::Ebig5plus::not_graph};
${Char::Ebig5plus::not_lower}   = ${Char::Ebig5plus::not_lower};
${Char::Ebig5plus::not_lower_i} = ${Char::Ebig5plus::not_lower_i};
${Char::Ebig5plus::not_print}   = ${Char::Ebig5plus::not_print};
${Char::Ebig5plus::not_punct}   = ${Char::Ebig5plus::not_punct};
${Char::Ebig5plus::not_space}   = ${Char::Ebig5plus::not_space};
${Char::Ebig5plus::not_upper}   = ${Char::Ebig5plus::not_upper};
${Char::Ebig5plus::not_upper_i} = ${Char::Ebig5plus::not_upper_i};
${Char::Ebig5plus::not_word}    = ${Char::Ebig5plus::not_word};
${Char::Ebig5plus::not_xdigit}  = ${Char::Ebig5plus::not_xdigit};
${Char::Ebig5plus::eb}          = ${Char::Ebig5plus::eb};
${Char::Ebig5plus::eB}          = ${Char::Ebig5plus::eB};
...
sub Char::Ebig5plus::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Char::Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
#
{
    ...
    $Char::Ebig5plus::matched = qr/(?{Char::Ebig5plus::matched})/;
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $fc = Char::Ebig5plus::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Ebig5plus::not_lower_i}',
                '[:^upper:]'  => '${Char::Ebig5plus::not_upper_i}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Ebig5plus::uc($char);
                        my $fc = Char::Ebig5plus::fc($char);
                        if ($uc eq $fc) {
...
sub Char::Ebig5plus::filetest {
    ...
    unless (CORE::eval qq{Char::Ebig5plus::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Ebig5plus::r(;*@) {
    ...
    # (and so on)
        ...
        if (-d "$_/.") {
            ...
            # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5plus::*()
...
sub Char::Ebig5plus::T(;*@) {
    ...
    #     croak 'Too many arguments for -T (Char::Ebig5plus::T)';
...
sub Char::Ebig5plus::filetest_ {
    ...
    unless (CORE::eval qq{Char::Ebig5plus::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Ebig5plus::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Ebig5plus::fc($_[0]) =~ /\A $pattern \z/xms };
...
sub my_home {
    ...
    if (defined $home and ! Char::Ebig5plus::d($home)) {
        $home = undef;
    }
    return $home;
}
...
sub Char::Ebig5plus::lstat(*) {
    ...
    if (-e $_) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5plus::lstat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
...
sub Char::Ebig5plus::stat(*) {
    ...
    if (defined fileno $fh) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5plus::stat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
        ...
        # rejected idea ...
            ...
            if (($] =~ /^5\.006/oxms)                     and
                ...
                *{'Dyna'.'Loader::dl_install_xsub'}{'CODE'}->('_SetCurrentDirectoryA', unpack('L', pack 'P', $x86));
                ...
                if (Char::Ebig5plus::fc($chdir) eq Char::Ebig5plus::fc($dir)) {
                    return 1;
                }
                else {
                    return 0;
...
#   long filename form.
        ...
        if (qx{ver} =~ /\b(?:Windows NT|Windows 2000)\b/oms) {
            ...
            for my $dirx (sort { CORE::length($a) <=> CORE::length($b) } @dirx) {
                if (Char::Ebig5plus::fc(CORE::substr $dirx,-CORE::length($subdir[-1]),CORE::length($subdir[-1])) eq Char::Ebig5plus::fc($subdir[-1])) {
        ...
        elsif (Char::Ebig5plus::fc($shortdir) eq Char::Ebig5plus::fc($dir)) {
            return 0;
        }
        return CORE::chdir $shortdir;
    }
        ...
        for my $prefix (@INC) {
            ...
            if (Char::Ebig5plus::f($realfilename)) {
                ...
                if (Char::Ebig5plus::e("$realfilename.e")) {
                    ...
                    if ($script =~ /^ \s* use \s+ Char::Big5Plus \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
...
sub Char::Big5Plus::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Big5Plus::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Ebig5plus::dot_s} \z/oxms) {
...
my $anchor = '';
$anchor = q{${Char::Ebig5plus::anchor}};
...
my $qq_substr  = qr{(?: Char::Big5Plus::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $matched     = '';
my $s_matched   = '';
$matched        = q{$Char::Ebig5plus::matched};
...
sub Char::Big5Plus::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Big5Plus::escape_token();
    }
...
#
sub Char::Big5Plus::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ebig5plus::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5plus::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ebig5plus::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5plus::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ebig5plus::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5plus::POSTMATCH()};
    }
...
# subroutines of package Char::Ebig5plus
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Big5Plus::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Big5Plus::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Big5Plus::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Big5Plus::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Big5Plus::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Big5Plus::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Big5Plus::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::fc';         }
    ...
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                         \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    ...
    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1),$2)"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest qw($1),";    }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::filetest(qw($1),$2)"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Ebig5plus::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1";                 }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::$1(::"."$2)";        }
    elsif (/\G -(t)                            \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "-t $2";                     }
    elsif (/\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lstat';              }
    elsif (/\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::stat';               }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::fc_';               }
    elsif (/\G \b lstat \b         (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::lstat_';            }
    elsif (/\G \b stat \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::stat_';             }
    elsif (/\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::glob_';             }
    elsif (/\G \b reverse \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_reverse;          }
    elsif (/\G \b getc \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_getc;             }
    elsif (/\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::opendir$1*";        }
    elsif (/\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ebig5plus::opendir$1*";        }
    elsif (/\G \b unlink \b        (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5plus::unlink';            }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ebig5plus::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Ebig5plus::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Ebig5plus::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Ebig5plus::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Ebig5plus::PREMATCH()]}
            ...
            $e_string .= q{Char::Ebig5plus::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Ebig5plus::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Ebig5plus::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Ebig5plus::POSTMATCH()]}
            ...
            $e_string .= q{Char::Ebig5plus::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Ebig5plus
        ...
        elsif ($string =~ /\G \b Char::Big5Plus::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5Plus::eval \b                                /oxgc) { $e_string .= 'eval Char::Big5Plus::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Ebig5plus::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5Plus::index \b                               /oxgc) { $e_string .= 'Char::Big5Plus::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Ebig5plus::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5Plus::rindex \b                              /oxgc) { $e_string .= 'Char::Big5Plus::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Ebig5plus::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $e_string .= "Char::Ebig5plus::filetest qw($1),";    $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $e_string .= "Char::Ebig5plus::filetest(qw($1),$2)"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $e_string .= "Char::Ebig5plus::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Ebig5plus::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $e_string .= "Char::Ebig5plus::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $e_string .= "Char::Ebig5plus::$1";          $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $e_string .= "Char::Ebig5plus::$1(::"."$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G -(t)                            \s+ (\w+)                                            /oxgc) { $e_string .= "-t $2";              $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ebig5plus::lstat';       $slash = 'm//'; }
        elsif ($string =~ /\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ebig5plus::stat';        $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5plus::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Ebig5plus::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Ebig5plus::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Ebig5plus::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Ebig5plus::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Ebig5plus::fc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat \b                                           /oxgc) { $e_string .= 'Char::Ebig5plus::lstat_';            $slash = 'm//'; }
        elsif ($string =~ /\G \b stat \b                                            /oxgc) { $e_string .= 'Char::Ebig5plus::stat_';             $slash = 'm//'; }
        elsif ($string =~ /\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                 \b                 /oxgc) { $e_string .= "Char::Ebig5plus::filetest_(qw($1))"; $slash = 'm//'; }
        elsif ($string =~ /\G    -([rwxoRWXOezsfdlpSbcugkTBMAC]) \b                 /oxgc) { $e_string .= "Char::Ebig5plus::${1}_";             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Ebig5plus::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Ebig5plus::glob_';             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ebig5plus::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ebig5plus::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b unlink \b                                          /oxgc) { $e_string .= 'Char::Ebig5plus::unlink';            $slash = 'm//'; }

# chdir
        elsif ($string =~ /\G \b (chdir) \b (?! \s* => ) /oxgc) {
            $slash = 'm//';

            $e_string .= 'Char::Ebig5plus::chdir';
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ebig5plus::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Ebig5plus::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Ebig5plus::dot_s}';
        }
        else {
            return '${Char::Ebig5plus::dot}';
        }
    }
    else {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ebig5plus::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ebig5plus::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Ebig5plus::uc($char[$i]) ne Char::Ebig5plus::fc($char[$i]))) {
            if (CORE::length(Char::Ebig5plus::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Ebig5plus::uc($char[$i])       . Char::Ebig5plus::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Ebig5plus::uc($char[$i]) . '|' . Char::Ebig5plus::fc($char[$i]) . ')';
            }
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ebig5plus::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5plus::ignorecase(Char::Ebig5plus::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5plus::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ebig5plus::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5plus::ignorecase(Char::Ebig5plus::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5plus::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ebig5plus::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5plus::ignorecase(Char::Ebig5plus::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5plus::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::Big5Plus::re_t=%s; local $Char::Big5Plus::re_a=''; while($Char::Big5Plus::re_t =~ %s){%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s$Char::Big5Plus::re_t="$Char::Big5Plus::re_a${1}$Char::Big5Plus::re_r$'"; pos($Char::Big5Plus::re_t)=length "$Char::Big5Plus::re_a${1}$Char::Big5Plus::re_r"; $Char::Big5Plus::re_a=substr($Char::Big5Plus::re_t,0,pos($Char::Big5Plus::re_t)); } return $Char::Big5Plus::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Big5Plus::re_r=CORE::eval $Char::Big5Plus::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Big5Plus::re_t=%s; while($Char::Big5Plus::re_t =~ %s){%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s$Char::Big5Plus::re_t="$`$Char::Big5Plus::re_r$'"; pos($Char::Big5Plus::re_t)=length "$`$Char::Big5Plus::re_r"; } return $Char::Big5Plus::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s"%s$Char::Big5Plus::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::Big5Plus::re_n=0; local $Char::Big5Plus::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s%s="$Char::Big5Plus::re_a${1}$Char::Big5Plus::re_r$'"; pos(%s)=length "$Char::Big5Plus::re_a${1}$Char::Big5Plus::re_r"; $Char::Big5Plus::re_a=substr(%s,0,pos(%s)); $Char::Big5Plus::re_n++} return %s$Char::Big5Plus::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Big5Plus::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s%s="$`$Char::Big5Plus::re_r$'"; pos(%s)=length "$`$Char::Big5Plus::re_r"; $Char::Big5Plus::re_n++} return %s$Char::Big5Plus::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s%s="%s$Char::Big5Plus::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Big5Plus::re_r=%s; %s%s="%s$Char::Big5Plus::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Big5Plus::re_r=CORE::eval $Char::Big5Plus::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Ebig5plus::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Ebig5plus::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
sub e_use_noimport {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5plus::_open_r($fh, $realfilename)) {
            local $/ = undef; # slurp mode
            my $script = <$fh>;
...
This module has run-time routines for use Char::Big5Plus software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Big5Plus software and not
...
=item Split string
  ...
  at all, Char::Ebig5plus::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Ebig5plus::split(//,  $word);
  @fields = Char::Ebig5plus::split(/:/, $line);
  @words  = Char::Ebig5plus::split(" ", $paragraph);
  @lines  = Char::Ebig5plus::split(/^/, $buffer);
  ...
  print join(":" => Char::Ebig5plus::split(/ */, "hi there"));
  ...
  Char::Ebig5plus::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Ebig5plus::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Ebig5plus::split with no arguments does. Thus,
  Char::Ebig5plus::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Ebig5plus::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Ebig5plus::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Ebig5plus::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Ebig5plus::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Ebig5plus::split is join, except that join can only join with the
...
=item Transliteration
  ...
  print Char::Ebig5plus::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'
...
=item Chop string
  ...
  character chopped. The Char::Ebig5plus::chop subroutine is used primary to remove the newline
  ...
  since Char::Ebig5plus::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Ebig5plus::chop a literal, only a variable. If you Char::Ebig5plus::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Ebig5plus::chop(@lines);

  You can Char::Ebig5plus::chop anything that is an lvalue, including an assignment:

  Char::Ebig5plus::chop($cwd = `pwd`);
  Char::Ebig5plus::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Ebig5plus::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Ebig5plus::chop returns the character
  ...
  In the most general case, Char::Ebig5plus::chop can be expressed using substr:

  $last_code = Char::Ebig5plus::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Ebig5plus::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Ebig5plus::chop;
...
=item Index string
  ...
  $byte_pos = Char::Ebig5plus::index($string,$substr,$byte_offset);
  $byte_pos = Char::Ebig5plus::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Ebig5plus::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Ebig5plus::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Ebig5plus::rindex($string,$substr);

  This subroutine works just like Char::Ebig5plus::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Ebig5plus::index).
  ...
  while (($byte_pos = Char::Big5Plus::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Ebig5plus::fc subroutine for case-insensitive comparisons via Char::Big5Plus
  software.
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Ebig5plus::ucfirst instead.
...
=item Upper case first character of string
  ...
  $titlecase = Char::Ebig5plus::ucfirst(substr($word,0,1)) . Char::Ebig5plus::lc(substr($word,1));
  ...
  $do_not_use = Char::Ebig5plus::ucfirst(Char::Ebig5plus::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Ebig5plus::fc($string);
  $fc = Char::Ebig5plus::fc_;

  New to Char::Big5Plus software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Ebig5plus::fc($a) eq Char::Ebig5plus::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Big5Plus software has always used casefolding semantics for
...
=item Make character
  ...
  that $code in the character set. For example, Char::Ebig5plus::chr(65) is "A" in either
  ASCII or Big5Plus, not Unicode. For the reverse of Char::Ebig5plus::chr, use Char::Big5Plus::ord.

=item File test subroutine Char::Ebig5plus::X
  ...
  ------------------------------------------------------------------------------
  Char::Ebig5plus::r(*), Char::Ebig5plus::r_()   File or directory is readable by this (effective) user or group
  Char::Ebig5plus::w(*), Char::Ebig5plus::w_()   File or directory is writable by this (effective) user or group
  Char::Ebig5plus::e(*), Char::Ebig5plus::e_()   File or directory name exists
  Char::Ebig5plus::x(*), Char::Ebig5plus::x_()   File or directory is executable by this (effective) user or group
  Char::Ebig5plus::z(*), Char::Ebig5plus::z_()   File exists and has zero size (always false for directories)
  Char::Ebig5plus::f(*), Char::Ebig5plus::f_()   Entry is a plain file
  Char::Ebig5plus::d(*), Char::Ebig5plus::d_()   Entry is a directory
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5plus::R(*), Char::Ebig5plus::R_()   File or directory is readable by this real user or group
                             Same as Char::Ebig5plus::r(*), Char::Ebig5plus::r_() on MacOS
  Char::Ebig5plus::W(*), Char::Ebig5plus::W_()   File or directory is writable by this real user or group
                             Same as Char::Ebig5plus::w(*), Char::Ebig5plus::w_() on MacOS
  Char::Ebig5plus::X(*), Char::Ebig5plus::X_()   File or directory is executable by this real user or group
                             Same as Char::Ebig5plus::x(*), Char::Ebig5plus::x_() on MacOS
  Char::Ebig5plus::l(*), Char::Ebig5plus::l_()   Entry is a symbolic link
  Char::Ebig5plus::S(*), Char::Ebig5plus::S_()   Entry is a socket
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5plus::o(*), Char::Ebig5plus::o_()   File or directory is owned by this (effective) user
  Char::Ebig5plus::O(*), Char::Ebig5plus::O_()   File or directory is owned by this real user
  Char::Ebig5plus::p(*), Char::Ebig5plus::p_()   Entry is a named pipe (a "fifo")
  Char::Ebig5plus::b(*), Char::Ebig5plus::b_()   Entry is a block-special file (like a mountable disk)
  Char::Ebig5plus::c(*), Char::Ebig5plus::c_()   Entry is a character-special file (like an I/O device)
  Char::Ebig5plus::u(*), Char::Ebig5plus::u_()   File or directory is setuid
  Char::Ebig5plus::g(*), Char::Ebig5plus::g_()   File or directory is setgid
  Char::Ebig5plus::k(*), Char::Ebig5plus::k_()   File or directory has the sticky bit set
  ------------------------------------------------------------------------------
  ...
  a filehandle. Both Char::Ebig5plus::T and Char::Ebig5plus::B doesn't work when given the special
  filehandle consisting of a solitary underline. Because Char::Ebig5plus::T has to read to
  do the test, you don't want to use Char::Ebig5plus::T on special files that might hang or
  give you other kinds or grief. So on most occasions you'll want to test with a
  Char::Ebig5plus::f first, as in:

  next unless Char::Ebig5plus::f($file) && Char::Ebig5plus::T($file);

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5plus::T(*), Char::Ebig5plus::T_()   File looks like a "text" file
  Char::Ebig5plus::B(*), Char::Ebig5plus::B_()   File looks like a "binary" file
  ------------------------------------------------------------------------------

  File ages for Char::Ebig5plus::M, Char::Ebig5plus::M_, Char::Ebig5plus::A, Char::Ebig5plus::A_, Char::Ebig5plus::C, and Char::Ebig5plus::C_
  ...
  next unless Char::Ebig5plus::M($file) > 0.5;     # files are older than 12 hours
  &newfile if Char::Ebig5plus::M($file) < 0;       # file is newer than process
  &mailwarning if int(Char::Ebig5plus::A_) == 90;  # file ($_) was accessed 90 days ago today

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5plus::M(*), Char::Ebig5plus::M_()   Modification age (measured in days)
  Char::Ebig5plus::A(*), Char::Ebig5plus::A_()   Access age (measured in days)
                             Same as Char::Ebig5plus::M(*), Char::Ebig5plus::M_() on MacOS
  Char::Ebig5plus::C(*), Char::Ebig5plus::C_()   Inode-modification age (measured in days)
  ------------------------------------------------------------------------------

  The Char::Ebig5plus::s, and Char::Ebig5plus::s_ returns file size in bytes if succesful, or undef
  unless successful.
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5plus::s(*), Char::Ebig5plus::s_()   File or directory exists and has nonzero size
...
=item Filename expansion (globbing)
  ...
  The Char::Ebig5plus::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Ebig5plus::glob('"*e f*"');
  @spacies = Char::Ebig5plus::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Ebig5plus::glob("'*${var}e f*'");
  @spacies = Char::Ebig5plus::glob(qq("*${var}e f*"));
...
=item Statistics about file
  ...
  $stat = Char::Ebig5plus::stat(FILEHANDLE);
  $stat = Char::Ebig5plus::stat(DIRHANDLE);
  $stat = Char::Ebig5plus::stat($expr);
  ...
  ($dev,$ino,$mode,$nlink,$uid,$gid,$rdev,$size,
      $atime,$mtime,$ctime,$blksize,$blocks) = Char::Ebig5plus::stat($expr);
  ...
  If Char::Ebig5plus::stat is passed the special filehandle consisting of an underline, no
  actual stat(2) is done, but the current contents of the stat structure from
  the last Char::Ebig5plus::stat, Char::Ebig5plus::lstat, or Char::Ebig5plus::stat-based file test subroutine
  (such as Char::Ebig5plus::r, Char::Ebig5plus::w, and Char::Ebig5plus::x) are returned.
  ...
  $mode = (Char::Ebig5plus::stat($expr))[2];
...
=item Require file
  ...
  Char::Ebig5plus::require loads and executes the Perl code found in the separate file whose
  name is given by the $file. This is similar to using a Char::Ebig5plus::do on a file, except
  that Char::Ebig5plus::require checks to see whether the library file has been loaded already
  ...
  its cousins Char::Ebig5plus::do, Char::Ebig5plus::require knows how to search the include path stored
