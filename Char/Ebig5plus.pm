...
=item Chop string
  ...
  character chopped. The Char::Ebig5plus::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ebig5plus::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Char::Ebig5plus::fc function for case-insensitive comparisons via Char::Big5Plus
  software.
...
=item Fold case string
  ...
  New to Char::Big5Plus software, this function returns the full Unicode-like casefold of
...
=item File test function Char::Ebig5plus::X
...
=item Filename expansion (globbing)
  ...
  The Char::Ebig5plus::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Ebig5plus::stat, Char::Ebig5plus::lstat, or Char::Ebig5plus::stat-based file test function
