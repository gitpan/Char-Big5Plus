...
if ((Char::Ebig5plus::T_ ne '') == (-T ne '')) {
    print "ok - 20 Char::Ebig5plus::T_ == -T  $^X $__FILE__\n";
}
else {
    print "not ok - 20 Char::Ebig5plus::T_ == -T  $^X $__FILE__\n";
}

$_ = 'file';
if ((Char::Ebig5plus::B_ ne '') == (-B ne '')) {
    print "ok - 21 Char::Ebig5plus::B_ == -B  $^X $__FILE__\n";
}
else {
    print "not ok - 21 Char::Ebig5plus::B_ == -B  $^X $__FILE__\n";
}

$_ = 'file';
if ((Char::Ebig5plus::M_ ne '') == (-M ne '')) {
    print "ok - 22 Char::Ebig5plus::M_ == -M  $^X $__FILE__\n";
}
else {
    print "not ok - 22 Char::Ebig5plus::M_ == -M  $^X $__FILE__\n";
}

$_ = 'file';
if ((Char::Ebig5plus::A_ ne '') == (-A ne '')) {
    print "ok - 23 Char::Ebig5plus::A_ == -A  $^X $__FILE__\n";
}
else {
    print "not ok - 23 Char::Ebig5plus::A_ == -A  $^X $__FILE__\n";
}

$_ = 'file';
if ((Char::Ebig5plus::C_ ne '') == (-C ne '')) {
    print "ok - 24 Char::Ebig5plus::C_ == -C  $^X $__FILE__\n";
}
else {
    print "not ok - 24 Char::Ebig5plus::C_ == -C  $^X $__FILE__\n";
}
