...
$var = '0123456789';
Char::Big5Plus::substr($var,4,2) =~ s/[0-9]+/KK/;
...
$var = '0123456789';
Char::Big5Plus::substr($var,4,3) =~ s/[0-9]/H/g;
...
$var = '0123456789';
my $var2 = Char::Big5Plus::substr($var,4,4) =~ s/[0-9]/I/r;
...
$var = '0123456789';
$var2 = Char::Big5Plus::substr($var,4,5) =~ s/[0-9]/I/gr;
